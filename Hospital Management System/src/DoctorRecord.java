...
PreparedStatement pst=null;
 ...
 private void Get_Data(){
      String sql="select DoctorName as 'Doctor Name', DoctorID as 'Doctor ID',Address,ContactNo as 'Contact No',Qualifications,Specialization,Fees,Fees_Validity as 'Fees Validity',DateOfJoining as 'Joining Date',Cabin as 'Cabin No.' from Doctor order by DoctorName";        
      try{
...
try{
            ...
            if(rs.next()){
                ...
                String add8=rs.getString("Fees");
                frm.txtFee.setText(add8);
                
                String add9=rs.getString("Fees_Validity");
                frm.txtFeesValidity.setText(add9);
                
                String add14=rs.getString("DateOfJoining");
                frm.txtDateOfJoining.setText(add14);
                
                String add10=rs.getString("Cabin");
                frm.txtCabin.setText(add10);
