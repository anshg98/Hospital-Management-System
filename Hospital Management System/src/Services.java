    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
     try{
      con=Connect.ConnectDB();
       ...
       String sql= "insert into Services(ServiceID,ServiceName,ServiceDate,PatientID,ServiceCharges)values('" + txtServiceID.getText() + "','"+ txtServiceName.getText() + "','"+ txtServiceDate.getText() + "','" + txtPatientID.getText() + "'," + txtServiceCharges.getText() + ")";
       pst=con.prepareStatement(sql);
       pst.execute();
