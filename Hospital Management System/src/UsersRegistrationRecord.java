...
PreparedStatement pst=null;
  ...
  private void Get_Data(){
        String sql="select NameOfUser as 'Name', UserName as 'User Name',Password,ContactNo as 'Contact No',Email as 'Email ID', usertype as 'User Type' from Registration";
        try{
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
            ...
            if(rs.next()){
                ...
                String add6=rs.getString("usertype");
                frm.cmbUserType.setSelectedItem(add6);
