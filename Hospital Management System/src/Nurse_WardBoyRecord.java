...
PreparedStatement pst=null;
 ...
 private void Get_Data(){
        String sql="select ID, W_N_name as 'Name',Category,Address,ContactNo as 'Contact No',Email as 'Email ID',Qualifications,DateOfJoining as 'Joining Date' from Wardboy_Nurse_tbl order by W_N_name";
        try{
